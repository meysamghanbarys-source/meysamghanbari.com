...
export const opticalRecords: OpticalRecord[] = [
  {
    ...
    image: '/images/records/optical-data-rate-map.svg', imageAlt: { en: 'Diagram of a high-rate optical downlink from a small satellite to a ground telescope', fa: 'نمودار لینک نوری پرسرعت از ماهواره کوچک به تلسکوپ زمینی' },
  ...
  },
  {
    ...
    image: '/images/records/optical-range-deep-space.svg', imageAlt: { en: 'Deep-space optical link diagram between Earth and the Psyche spacecraft', fa: 'نمودار لینک نوری اعماق فضا میان زمین و فضاپیمای Psyche' },
  ...
  },
  {
    ...
    image: '/images/records/optical-range-deep-space.svg', imageAlt: { en: 'Lunar optical communication link from LADEE to multiple ground stations', fa: 'لینک نوری ماه از LADEE به چند ایستگاه زمینی' },
  ...
  },
  {
    ...
    image: '/images/records/optical-relay-network.svg', imageAlt: { en: 'Aircraft-to-geostationary-satellite laser communication link', fa: 'لینک مخابرات لیزری میان هواپیما و ماهوارهٔ زمین‌آهنگ' },
  ...
  },
  {
    ...
    image: '/images/records/optical-relay-network.svg', imageAlt: { en: 'LEO-to-GEO optical relay architecture used by the European Data Relay System', fa: 'معماری رلهٔ نوری مدار پایین به GEO در سامانهٔ رلهٔ دادهٔ اروپا' },
  ...
  },
  {
    ...
    image: '/images/records/optical-precision-tracking.svg', imageAlt: { en: 'Sub-microradian point-ahead mirror control concept for deep-space optical communication', fa: 'مفهوم کنترل زیرمیکرورادیانی آینهٔ پیش‌نشانه‌روی برای مخابرات نوری اعماق فضا' },
  ...
  },
  {
    ...
    image: '/images/records/optical-precision-tracking.svg', imageAlt: { en: 'Star-referenced pointing calibration and sub-second acquisition for a space optical terminal', fa: 'کالیبراسیون نشانه‌روی با مرجع ستاره‌ای و کسب زیر یک ثانیه برای ترمینال نوری فضایی' },
  ...
  },
  {
    ...
    image: '/images/records/optical-precision-tracking.svg', imageAlt: { en: 'Fine-pointing and acquisition diagram for a CubeSat optical downlink', fa: 'نمودار کسب و نشانه‌روی دقیق برای لینک نوری CubeSat به زمین' },
  ...
  },
  {
    ...
    image: '/images/records/optical-quantum-link.svg', imageAlt: { en: 'Satellite distributing entangled photons to two distant ground stations', fa: 'ماهواره در حال توزیع فوتون‌های درهم‌تنیده به دو ایستگاه زمینی دوردست' },
  ...
  },
  {
    ...
    image: '/images/records/optical-quantum-link.svg', imageAlt: { en: 'Entanglement-based satellite quantum key distribution architecture', fa: 'معماری توزیع کلید کوانتومی ماهواره‌ای مبتنی بر درهم‌تنیدگی' },
  ...
  },
  {
    ...
    image: '/images/records/optical-quantum-link.svg', imageAlt: { en: 'Quantum-secure optical time transfer between satellite and ground clock', fa: 'انتقال زمان نوری امن کوانتومی میان ماهواره و ساعت زمینی' },
  ...
  },
  {
    ...
    image: '/images/records/optical-power-beaming.svg', imageAlt: { en: 'Long-range laser power beaming to a photovoltaic receiver', fa: 'انتقال توان لیزری دوربرد به گیرندهٔ فتوولتائیک' },
  ...
  },
  {
    ...
    image: '/images/records/optical-relay-network.svg', imageAlt: { en: 'Concept diagram of a multi-orbit terabit optical transport network', fa: 'نمودار مفهومی شبکهٔ انتقال نوری ترابیتی چندمداری' },
  ...
  },
  {
    ...
    image: '/images/records/optical-quantum-link.svg', imageAlt: { en: 'European satellite quantum-key-distribution validation concept', fa: 'مفهوم اعتبارسنجی اروپایی توزیع کلید کوانتومی ماهواره‌ای' },
  ...
  },
  {
    ...
    image: '/images/records/optical-relay-network.svg', imageAlt: { en: 'Conceptual multi-orbit optical backbone with LEO and MEO satellites', fa: 'ستون‌فقرات نوری چندمداری مفهومی با ماهواره‌های LEO و MEO' },
  ...
  },
  {
    ...
    image: '/images/records/optical-power-beaming.svg', imageAlt: { en: 'Concept of optical power beams redirected by airborne relay nodes', fa: 'مفهوم هدایت مجدد پرتوهای توان نوری توسط گره‌های رلهٔ هوابرد' },
